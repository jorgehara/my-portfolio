    ...
    <>
      <div class="d-flex justify-content-center">
        <div class="col-md-6 justify-content-center">
          <div class="card card-header text-white bg-dark col w-100 h-80 rounded-1">
            <div class="card card-header text-center border-0 fs-4 fw-semibold ">
              Project One
            </div>
            <div class="card-body p-2">
              ...
              <p class="card-text p-2 my-1 text-start lh-3">
                ...
                <Link
                  href="/"
                  className="btn btn-outline-light bg-gradient rounded-1 text-center lh-sm col-3 m-1 p-1 pt-1"
                >
                  Know more
                </Link>
              </p>
        ...
        <div class="col-md-6 justify-content-center">
          <div class="card card-header text-white bg-dark col w-100 h-80 rounded-1">
            <div class="card-header text-center border-0 fs-4 fw-semibold  ">
              Project Two
            </div>
            <div class="card-body p-2">
              <Image
